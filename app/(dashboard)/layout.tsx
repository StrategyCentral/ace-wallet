...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen bg-ace-bg">
      {/* Sidebar */}
      <aside className={`flex flex-col border-r border-ace-border bg-ace-card transition-all duration-200 ${collapsed ? 'w-16' : 'w-56'}`} style={{ minHeight: '100vh' }}>
        ...
        <div className="px-2 pb-4">
          <button onClick={logout}
            className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-ace-muted hover:text-ace-red hover:bg-ace-red/5 transition-all">
